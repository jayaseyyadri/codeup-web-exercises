...
var googleWorkHours = Number(prompt("Please input number of hours worked : google"));
...
var itemNumber = Number(prompt("How many items do you have? "));

var discountApplied = (offerValid && (isPremium)|| itemNumber>2);
