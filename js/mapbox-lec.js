...
alamoM.setPopup(alamoPopup);
alamoPopup.maxWidth='none'
...
geocode('mapbox-geocoder-utils.js  salmiya,kuwait',mapboxToken).then(function (result){
    console.log(result);
...
reverseGeocode({lng :-98.4861,lat :29.4250},mapboxToken).then(function (result){
    console.log(result);
})
...
>>>>>>> 23286bcb71afaa37c4ca3ce2561a9f380d37556b
